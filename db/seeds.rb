...
companies = Company.create({status:"ok", active:true, user_id:14, name:"Graubündner Kantonalbank", partner:false, mcategory_id:26 ,stichworte: "Banken", address1:"Bahnhof", address2:"Chur", address3:"Graubünden"}) 
