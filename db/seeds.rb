...
#create Question categories 109
...
mobjects = Mobject.create({status:"OK", active:true, mtype:"sensoren", msubtype:nil, name:"Kundenzufriedenheit", date_from:Date.today, date_to:Date.today+5, owner_type:"User", owner_id: 1, mcategory_id:114, address1: "", address2: "", address3: "", mini:0, maxi:100, alert:80, alertlow:true })
