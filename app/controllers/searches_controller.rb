    ...
    if params[:ticket_id]
      ...
      if params[:activate]
        ...
        @usertickets.each do |ut|
          ut.status = "übergeben"
          content = "Ticket_ID:"+ut.id.to_s+ " für " + ut.ticket.name + " für " + ut.user.name + " " + ut.user.lastname + " für Event " + ut.ticket.msponsor.mobject.name + " gesponsort von " + ut.ticket.msponsor.company.name
