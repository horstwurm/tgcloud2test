class PlanningsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @planning.save
        format.html { redirect_to user_path(:id => @planning.user_id, :topic => :ressourcenplanung, :scope => @planning.costortime, :year => @planning.jahr, :month => @planning.monat), notice: (I18n.t )}
  ...
  def update
    respond_to do |format|
      if @planning.update(planning_params)
        format.html { redirect_to user_path(:id => @planning.user_id, :topic => :ressourcenplanung, :scope => @planning.costortime, :year => @planning.jahr, :month => @planning.monat), notice: 'Planning was successfully updated.' }
  ...
  def destroy
    ...
    @planning.destroy
    respond_to do |format|
      format.html { redirect_to user_path(:id => @planning_user_id, :topic => :ressourcenplanung, :scope => @planning_costortime), notice: 'Planning was successfully destroyed.' }
