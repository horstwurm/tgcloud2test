class CritsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @crit.save
        format.html { redirect_to mobject_path(:id => @crit.mobject_id, :topic => "objekte_bewertungskriterien"), notice: (I18n.t :act_create)}
  ...
  def update
    respond_to do |format|
      if @crit.update(crit_params)
        format.html { redirect_to mobject_path(:id => @crit.mobject_id, :topic => "objekte_bewertungskriterien"), notice: (I18n.t :act_update) }
  ...
  def destroy
    ...
    @crit.destroy
    respond_to do |format|
      format.html { redirect_to mobject_path(:id => @crit_mobject_id, :topic => "objekte_bewertungskriterien"), notice: (I18n.t :act_delete) }
