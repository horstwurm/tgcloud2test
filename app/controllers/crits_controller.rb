class CritsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @crit.save
        format.html { redirect_to mobject_path(:id => @crit.mobject_id, :topic => "Bewertungskriterien"), notice: 'Crit was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @crit.update(crit_params)
        format.html { redirect_to mobject_path(:id => @crit.mobject_id, :topic => "Bewertungskriterien"), notice: 'Crit was successfully updated.' }
  ...
  def destroy
    ...
    @crit.destroy
    respond_to do |format|
      format.html { redirect_to mobject_path(:id => @crit_mobject_id, :topic => "Bewertungskriterien"), notice: 'Crit was successfully destroyed.' }
