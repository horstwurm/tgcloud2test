class CredentialsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @credential.save
        format.html { redirect_to user_path(:id => @credential.user_id, :topic => "Zugriffsberechtigungen"), notice: 'Credential was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @credential.update(credential_params)
        format.html { redirect_to user_path(:id => @credential.user_id, :topic => "Zugriffsberechtigungen"), notice: 'Credential was successfully updated.' }
  ...
  def destroy
    @credential.destroy
    respond_to do |format|
      format.html { redirect_to user_path(:id => @credential.user_id, :topic => "Zugriffsberechtigungen"), notice: 'Credential was successfully destroyed.' }
