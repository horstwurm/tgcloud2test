...
class ParticipantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create participant" do
    assert_difference('Participant.count') do
      post participants_url, params: { participant: { mobject_id: @participant.mobject_id, status: @participant.status, user_id: @participant.user_id } }
    end
  ...
  test "should update participant" do
    patch participant_url(@participant), params: { participant: { mobject_id: @participant.mobject_id, status: @participant.status, user_id: @participant.user_id } }
