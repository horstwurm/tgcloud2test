...
class PricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post prices_url, params: { price: { description: @price.description, mobject_id: @price.mobject_id, name: @price.name, sequence: @price.sequence } }
    end
  ...
  test "should update price" do
    patch price_url(@price), params: { price: { description: @price.description, mobject_id: @price.mobject_id, name: @price.name, sequence: @price.sequence } }
