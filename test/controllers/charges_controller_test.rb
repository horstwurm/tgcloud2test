...
class ChargesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create charge" do
    assert_difference('Charge.count') do
      post charges_url, params: { charge: { amount: @charge.amount, owner_id: @charge.owner_id, owner_type: @charge.owner_type, plan: @charge.plan, stripe_id: @charge.stripe_id } }
    end
  ...
  test "should update charge" do
    patch charge_url(@charge), params: { charge: { amount: @charge.amount, owner_id: @charge.owner_id, owner_type: @charge.owner_type, plan: @charge.plan, stripe_id: @charge.stripe_id } }
