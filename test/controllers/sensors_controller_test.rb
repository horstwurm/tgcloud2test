...
class SensorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sensor" do
    assert_difference('Sensor.count') do
      post sensors_url, params: { sensor: { mobject_id: @sensor.mobject_id, value: @sensor.value } }
    end
  ...
  test "should update sensor" do
    patch sensor_url(@sensor), params: { sensor: { mobject_id: @sensor.mobject_id, value: @sensor.value } }
