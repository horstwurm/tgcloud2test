...
class EditionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create edition" do
    assert_difference('Edition.count') do
      post editions_url, params: { edition: { description: @edition.description, mobject_id: @edition.mobject_id, name: @edition.name, status: @edition.status } }
    end
  ...
  test "should update edition" do
    patch edition_url(@edition), params: { edition: { description: @edition.description, mobject_id: @edition.mobject_id, name: @edition.name, status: @edition.status } }
