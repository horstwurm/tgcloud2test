...
class CredentialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create credential" do
    assert_difference('Credential.count') do
      post credentials_url, params: { credential: { access: @credential.access, scope: @credential.scope, user_id: @credential.user_id } }
    end
  ...
  test "should update credential" do
    patch credential_url(@credential), params: { credential: { access: @credential.access, scope: @credential.scope, user_id: @credential.user_id } }
